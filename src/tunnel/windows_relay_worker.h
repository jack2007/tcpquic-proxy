...
struct TqWindowsRelayWorkerSnapshot {
    ...
    uint64_t WindowsTerminalSealCount{0};
    uint64_t WindowsTerminalIocpPostCount{0};
    uint64_t WindowsTerminalIocpPostFailedCount{0};
    uint64_t WindowsTerminalLogicalDetachCount{0};
    uint64_t WindowsTerminalApiSuppressedCount{0};
    uint64_t PendingOverlappedTcpRecvs{0};
    uint64_t PendingOverlappedTcpSends{0};
    uint64_t PendingOverlappedWorkerOps{0};
    uint64_t TcpCancelRequestedCount{0};
    uint64_t TcpCancelNotFoundCount{0};
    uint64_t TcpCancelErrorCount{0};
    uint64_t StopDrainRemaining{0};
    uint64_t TerminalRetainedOwnerCount{0};
    uint64_t TerminalRetainedOldestAgeMs{0};
    uint64_t SendCompletionRegistryCount{0};
    uint64_t TerminalShutdownSinkPendingCount{0};
    uint64_t TerminalOperationPendingCount{0};
...
private:
    ...
    std::atomic<uint64_t> WindowsTerminalSealCount_{0};
    std::atomic<uint64_t> WindowsTerminalIocpPostCount_{0};
    std::atomic<uint64_t> WindowsTerminalIocpPostFailedCount_{0};
    std::atomic<uint64_t> WindowsTerminalLogicalDetachCount_{0};
    std::atomic<uint64_t> TcpCancelRequestedCount_{0};
    std::atomic<uint64_t> TcpCancelNotFoundCount_{0};
    std::atomic<uint64_t> TcpCancelErrorCount_{0};
