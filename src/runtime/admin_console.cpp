...
@media(max-width:1180px){.peer-layout,.split{grid-template-columns:1fr}.span-3,.span-5,.span-6,.span-7{grid-column:span 12}}
...
<body>
  ...
  {"listen":"127.0.0.1:2222","target_host":"10.8.0.9","target_port":22}
        ...
        <section id="client-connections" class="page">
          ...
          <div class="card table-scroll"><table><thead><tr><th>connection_id</th><th>peer_id</th><th>slot_index</th><th>generation</th><th>connected</th><th>retry_scheduled</th><th>state</th><th>path</th><th>local</th><th>peer</th><th>active_tunnels</th><th>last_error</th></tr></thead><tbody><tr><td>conn-0</td><td>dgx-b</td><td>0</td><td>12</td><td>true</td><td>false</td><td><span class="state ok">connected</span></td><td>path-a</td><td>10.201.1.1</td><td>10.201.1.2:4433</td><td>18</td><td>-</td></tr></tbody></table></div>
        </section>
        ...
        <section id="server-peers" class="page">
          ...
          <div class="card table-scroll"><table><thead><tr><th>peer</th><th>remote_address</th><th>connections</th><th>active_streams</th><th>total_streams</th><th>active_tunnels</th><th>last_error</th></tr></thead><tbody><tr><td>peer-10.201.1.1</td><td>10.201.1.1:53221</td><td>4</td><td>42</td><td>816</td><td>42</td><td>-</td></tr></tbody></table></div>
        ...
        <section id="server-tunnels" class="page">
          ...
          <div class="card table-scroll"><table><thead><tr><th>tunnel_id</th><th>peer_id</th><th>connection_id</th><th>state</th><th>target</th><th>role</th><th>duration_ms</th><th>active</th></tr></thead><tbody><tr><td>srv-tun-9012</td><td>peer-10.201.1.1</td><td>srv-21</td><td><span class="state ok">active</span></td><td>10.8.0.9:22</td><td>server</td><td>1320000</td><td>true</td></tr></tbody></table></div>
        </section>
        ...
        <section id="server-acl" class="page">
          ...
          <div class="grid"><div class="card span-7 table-scroll"><h3>规则摘要</h3><table><thead><tr><th>type</th><th>targets</th></tr></thead><tbody><tr><td><span class="state ok">allow_targets</span></td><td>10.8.0.0/16, 172.16.0.0/16</td></tr><tr><td><span class="state err">deny_targets</span></td><td>10.9.0.0/16</td></tr></tbody></table></div><div class="card span-5"><h3>统计</h3><div class="metric"><span class="label">acl_denied</span><span class="value">3</span><span class="note">from /api/v1/metrics</span></div></div></div>
        </section>
...
const pageDefs = {
  client: [
    ['login', 'IN', 'Login', 'info'],
    ['client-overview', 'OV', 'Overview', 'ok'],
    ['client-peers', 'PE', 'Peers', 'ok'],
    ['client-connections', 'CN', 'Connections', 'warn'],
    ['client-tunnels', 'TU', 'Tunnels', 'ok'],
    ['relay', 'RE', 'Relay', 'info'],
    ['config', 'CF', 'Config', 'warn'],
    ['diagnostics', 'DG', 'Diagnostics', 'info']
  ],
  server: [
    ['login', 'IN', 'Login', 'info'],
    ['server-overview', 'OV', 'Overview', 'ok'],
    ['server-peers', 'PE', 'Peers', 'ok'],
    ['server-connections', 'CN', 'Connections', 'ok'],
    ['server-tunnels', 'TU', 'Tunnels', 'ok'],
    ['server-acl', 'AC', 'ACL', 'warn'],
    ['relay', 'RE', 'Relay', 'info'],
    ['config', 'CF', 'Config', 'warn'],
    ['diagnostics', 'DG', 'Diagnostics', 'info']
  ]
