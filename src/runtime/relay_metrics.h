...
struct TqRelayMetricsSnapshot {
    ...
    uint64_t RelayControlGenerationMismatch{0};
    uint64_t RelayAccountingDuplicateRelease{0};
    uint64_t RelayPreparedRelays{0};
    uint64_t RelayCommitSuccessCount{0};
    uint64_t RelayTerminalBeforeCommitRollbacks{0};
    uint64_t RelayActivationFailureCount{0};
    uint64_t RelayPrecommitBytes{0};
    uint64_t RelayPrecommitDepth{0};
    uint64_t RelayActiveSendReservations{0};
    uint64_t RelaySendReservationRollbacks{0};
    uint64_t RelaySendReservationOldestAgeMs{0};
    uint64_t RelayPendingReceiveActive{0};
    uint64_t RelayReceiveDiscards{0};
    uint64_t RelayActiveFailureAllocationFailed{0};
    uint64_t RelayActiveFailureBudgetExceeded{0};
    uint64_t RelayActiveFailureQueueFull{0};
    uint64_t RelayShutdownSinkActive{0};
    ...
    uint64_t WindowsPendingOverlappedTcpRecvs{0};
    uint64_t WindowsPendingOverlappedTcpSends{0};
    uint64_t WindowsPendingOverlappedWorkerOps{0};
    uint64_t WindowsTcpCancelRequestedCount{0};
    uint64_t WindowsTcpCancelNotFoundCount{0};
    uint64_t WindowsTcpCancelErrorCount{0};
    uint64_t WindowsRelayStopDrainRemaining{0};
    uint64_t WindowsRelayTerminalRetainedOwnerCount{0};
    uint64_t WindowsRelayTerminalRetainedOldestAgeMs{0};
    uint64_t WindowsRelaySendCompletionRegistryCount{0};
    uint64_t WindowsRelayTerminalShutdownSinkPendingCount{0};
    uint64_t WindowsRelayTerminalOperationPendingCount{0};
