...
- **35316.65 Mbps** (35.317 Gbps)

## 对比表

| 工具 | 场景 | conns/streams 或 quic×curl | Mbps | Gbps | vs msquic 单连接 |
|------|------|---------------------------|------|------|------------------|
| tcpquic-proxy | 多流 | quic=16 curl=4 | 27935.58 | 27.936 | — |
| tcpquic-proxy | 多流 | quic=4 curl=16 | 35942.54 | 35.943 | — |
...
报告: /home/jack/src/tcpquic-proxy/docs/dgx-current-io-isolation-20260620.md
