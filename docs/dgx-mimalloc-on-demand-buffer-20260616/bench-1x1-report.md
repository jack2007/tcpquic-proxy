...
- **36477.16 Mbps** (36.477 Gbps)

## 对比表

| 工具 | 场景 | conns/streams 或 quic×curl | Mbps | Gbps | vs msquic 单连接 |
|------|------|---------------------------|------|------|------------------|
| secnetperf | 单连接下载 | conns=1 | 18551.39 | 18.551 | 100% |
| secnetperf | 16 连接下载 | conns=16 | 63067.86 | 63.068 | — |
| secnetperf | 单连接 16 stream | conns=1 streams=16 | 17137.19 | 17.137 | — |
| tcpquic-proxy | HTTP CONNECT 单流 | quic=1 curl=1 | 16988.79 | 16.989 | 91.6% |
| tcpquic-proxy | 多流 | quic=16 curl=16 | 53012.62 | 53.013 | — |
| tcpquic-proxy | 多流（最佳） | quic=16 curl=4 | 70288.22 | 70.288 | — |
...
报告: docs/dgx-mimalloc-on-demand-buffer-20260616/bench-1x1-report.md
