...
- **22466.98 Mbps** (22.467 Gbps)

## 对比表

| 工具 | 场景 | conns/streams 或 quic×curl | Mbps | Gbps | vs msquic 单连接 |
|------|------|---------------------------|------|------|------------------|
| secnetperf | 单连接下载 | conns=1 | 1370.84 | 1.371 | 100% |
| secnetperf | 16 连接下载 | conns=16 | 44419.03 | 44.419 | — |
| secnetperf | 单连接 16 stream | conns=1 streams=16 | 873.90 | 0.874 | — |
| tcpquic-proxy | HTTP CONNECT 单流 | quic=1 curl=1 | 14086.80 | 14.087 | 1027.6% |
| tcpquic-proxy | 多流 | quic=16 curl=16 | 8249.16 | 8.249 | — |
| tcpquic-proxy | 多流（最佳） | quic=16 curl=4 | 10176.36 | 10.176 | — |
...
报告: /tmp/dgx-phase3-event-queue-baseline-20260612-011756.md
