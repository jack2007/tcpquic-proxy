...
> 评审日期：2026-06-09  
> 评审范围：本文档（目标架构）  
> 对照基线：`src/docs/thread_model_cn.md`、当前 `src/tunnel/relay.cpp` / `src/tunnel/tcp_write_queue.cpp` / `src/tunnel/tcp_tunnel.cpp`  
...
| 文档 | 关系 | 动作 |
|------|------|------|
| `src/docs/thread_model_cn.md` | 当前线程模型基线 | 本文视为 §10「epoll 多路复用」的展开设计；建议在 thread_model 增加指向本文的链接 |
