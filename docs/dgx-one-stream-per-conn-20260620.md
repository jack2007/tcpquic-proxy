...
- **42253.65 Mbps** (42.254 Gbps)

## 对比表

| 工具 | 场景 | conns/streams 或 quic×curl | Mbps | Gbps | vs msquic 单连接 |
|------|------|---------------------------|------|------|------------------|
| tcpquic-proxy | HTTP CONNECT 单流 | quic=1 curl=1 | 19375.80 | 19.376 | n/a |
| tcpquic-proxy | 多流 | quic=2 curl=2 | 26818.18 | 26.818 | — |
| tcpquic-proxy | 多流 | quic=4 curl=4 | 31347.30 | 31.347 | — |
...
报告: /home/jack/src/tcpquic-proxy/docs/dgx-one-stream-per-conn-20260620.md
