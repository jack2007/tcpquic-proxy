...
- [ ] **Step 1: 先添加会编译失败的公共 helper 测试 target**
...
- [ ] **Step 3: 添加 lease 与 Stop barrier 的确定性测试**
...
- [ ] **Step 1: 写 IOCP shared-command 失败测试**
...
- [ ] **Step 2: 给 IO operation 增加 shared control owner**
...
- [ ] **Step 3: 重写 Windows SnapshotCommand wait/completion**
...
- [ ] **Step 4: 补齐 Windows worker snapshot 字段**
...
- [ ] **Step 2: 替换 RuntimeWorkerLifetimeLock**
...
- [ ] **Step 3: staged Start 与 bounded Snapshot**
...
- [ ] **Step 5: 运行 Windows Runtime test**
...
- [ ] **Step 2: 扩展 neutral snapshot structs**
...
- [ ] **Step 3: 添加 Darwin/Windows converters**
...
- [ ] **Step 4: 删除 workers endpoint 的双重采样**
...
- [ ] **Step 5: 接入 `/relay/metrics` complete 与 neutral stats**
...
- [ ] **Step 6: 运行当前平台 metrics/router tests**
...
- [ ] **Step 2: 用结果对象替换 found/supported bool 组合**
