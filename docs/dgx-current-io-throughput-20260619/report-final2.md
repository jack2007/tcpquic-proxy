...
- **34585.64 Mbps** (34.586 Gbps)

## 对比表

| 工具 | 场景 | conns/streams 或 quic×curl | Mbps | Gbps | vs msquic 单连接 |
|------|------|---------------------------|------|------|------------------|
| tcpquic-proxy | HTTP CONNECT 单流 | quic=1 curl=1 | 20488.76 | 20.489 | n/a |
| tcpquic-proxy | 多流 | quic=4 curl=4 | 26982.21 | 26.982 | — |
| tcpquic-proxy | 多流 | quic=16 curl=4 | 26464.95 | 26.465 | — |
...
报告: /home/jack/src/tcpquic-proxy/docs/dgx-current-io-throughput-20260619/report-final2.md
