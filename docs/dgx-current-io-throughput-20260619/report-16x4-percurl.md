...
- **40244.11 Mbps** (40.244 Gbps)

## 对比表

| 工具 | 场景 | conns/streams 或 quic×curl | Mbps | Gbps | vs msquic 单连接 |
|------|------|---------------------------|------|------|------------------|
| tcpquic-proxy | 多流 | quic=16 curl=4 | 30752.76 | 30.753 | — |
...
报告: /home/jack/src/tcpquic-proxy/docs/dgx-current-io-throughput-20260619/report-16x4-percurl.md
